...
const fetchLeaderboard_createServerFn_handler = createServerRpc({
  id: "7f63a85a3610a9cfcfe6a1e7f7d533b18795ff6325aa0c265fb5306abff255b5",
  name: "fetchLeaderboard",
  filename: "src/routes/_authenticated/leaderboard.tsx"
}, (opts) => fetchLeaderboard.__executeServer(opts));
const fetchLeaderboard = createServerFn({
  method: "GET"
}).middleware([requireAuth]).handler(fetchLeaderboard_createServerFn_handler, async ({
  context
}) => {
  try {
    const {
      data
    } = await serverApiClient.get("/ai/leaderboard", {
      headers: {
...
export {
  fetchLeaderboard_createServerFn_handler
};

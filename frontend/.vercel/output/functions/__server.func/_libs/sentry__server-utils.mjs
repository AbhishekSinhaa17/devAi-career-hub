import { d as debug, b2 as startSpanManual, c as SEMANTIC_ATTRIBUTE_SENTRY_OP, S as SEMANTIC_ATTRIBUTE_SENTRY_ORIGIN, f as SPAN_STATUS_ERROR } from "./sentry__core.mjs";
...
export {
  subscribeRedisDiagnosticChannels as s
};
